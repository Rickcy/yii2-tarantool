...
class ActiveQuery extends Query implements ActiveQueryInterface
{
    ...
    {
        $rows = $this->createCommand($db)->query()->getData();
     ...
     *
     * @param \rickcy\tarantool\Connection|null $db the DB connection used to create the DB command.
     * If `null`, the DB connection returned by [[modelClass]] will be used.
     *
     * @return \rickcy\tarantool\Command the created DB command instance.
     * @throws \Exception
     */
    public function createCommand($db = null) : Command
    {
        /* @var $modelClass \rickcy\tarantool\ActiveRecord */
     ...
     * @param \rickcy\tarantool\ActiveRecord $model the primary model
     ...
     * @return $this the query object itself
     * @throws \Exception when query is not initialized properly
     * @see via()
     */
